...
exports.deleteMedia = exports.updateMedia = exports.addMedia = exports.getMedia = exports.getAllMedia = void 0;
/******************
 * ENTRIES CONTROLLER
 */
...
const addMedia = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        newMedia._id = new mongodb_1.ObjectId(fillerMedia.length);
    ...
    try {
        ...
        if (req.body.entry_ids) {
            ...
            req.body.entry_ids.forEach((id) => {
                entry_object_ids.push(new mongodb_1.ObjectId(id));
            });
